...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "RoadGate — Roadmap con capacidad real" },
      { property: "og:description", content: "Planifica el roadmap de tu producto considerando la capacidad real de tu equipo." },
